...
UsersSavedTracksItemEntity _$UsersSavedTracksItemEntityFromJson(
    Map<String, dynamic> json) {
  return _UsersSavedTracksItemEntity.fromJson(json);
}

/// @nodoc
mixin _$UsersSavedTracksItemEntity {
  String? get addedAt => throw _privateConstructorUsedError;
  Track? get track => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $UsersSavedTracksItemEntityCopyWith<UsersSavedTracksItemEntity>
      get copyWith => throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UsersSavedTracksItemEntityCopyWith<$Res> {
  factory $UsersSavedTracksItemEntityCopyWith(UsersSavedTracksItemEntity value,
          $Res Function(UsersSavedTracksItemEntity) then) =
      _$UsersSavedTracksItemEntityCopyWithImpl<$Res,
          UsersSavedTracksItemEntity>;
  @useResult
...
/// @nodoc
class _$UsersSavedTracksItemEntityCopyWithImpl<$Res,
        $Val extends UsersSavedTracksItemEntity>
    implements $UsersSavedTracksItemEntityCopyWith<$Res> {
  _$UsersSavedTracksItemEntityCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$UsersSavedTracksItemEntityImplCopyWith<$Res>
    implements $UsersSavedTracksItemEntityCopyWith<$Res> {
  factory _$$UsersSavedTracksItemEntityImplCopyWith(
          _$UsersSavedTracksItemEntityImpl value,
          $Res Function(_$UsersSavedTracksItemEntityImpl) then) =
      __$$UsersSavedTracksItemEntityImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String? addedAt, Track? track});
...
/// @nodoc
class __$$UsersSavedTracksItemEntityImplCopyWithImpl<$Res>
    extends _$UsersSavedTracksItemEntityCopyWithImpl<$Res,
        _$UsersSavedTracksItemEntityImpl>
    implements _$$UsersSavedTracksItemEntityImplCopyWith<$Res> {
  __$$UsersSavedTracksItemEntityImplCopyWithImpl(
      _$UsersSavedTracksItemEntityImpl _value,
      $Res Function(_$UsersSavedTracksItemEntityImpl) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$UsersSavedTracksItemEntityImpl(
      addedAt: freezed == addedAt
          ? _value.addedAt
          : addedAt // ignore: cast_nullable_to_non_nullable
              as String?,
...
class _$UsersSavedTracksItemEntityImpl implements _UsersSavedTracksItemEntity {
  const _$UsersSavedTracksItemEntityImpl({this.addedAt, this.track});

  factory _$UsersSavedTracksItemEntityImpl.fromJson(
          Map<String, dynamic> json) =>
      _$$UsersSavedTracksItemEntityImplFromJson(json);
  ...
  @override
  String toString() {
    return 'UsersSavedTracksItemEntity(addedAt: $addedAt, track: $track)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$UsersSavedTracksItemEntityImpl &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$UsersSavedTracksItemEntityImplCopyWith<_$UsersSavedTracksItemEntityImpl>
      get copyWith => __$$UsersSavedTracksItemEntityImplCopyWithImpl<
          _$UsersSavedTracksItemEntityImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$UsersSavedTracksItemEntityImplToJson(
      this,
    );
  }
}

abstract class _UsersSavedTracksItemEntity
    implements UsersSavedTracksItemEntity {
  const factory _UsersSavedTracksItemEntity(
      {final String? addedAt,
      final Track? track}) = _$UsersSavedTracksItemEntityImpl;

  factory _UsersSavedTracksItemEntity.fromJson(Map<String, dynamic> json) =
      _$UsersSavedTracksItemEntityImpl.fromJson;
