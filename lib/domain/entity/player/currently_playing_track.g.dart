...
_$_CurrentlyPlayingTrackModel _$$_CurrentlyPlayingTrackModelFromJson(
...
Map<String, dynamic> _$$_CurrentlyPlayingTrackModelToJson(
        _$_CurrentlyPlayingTrackModel instance) =>
    <String, dynamic>{
