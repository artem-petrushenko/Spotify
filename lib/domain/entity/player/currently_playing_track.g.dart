...
_$CurrentlyPlayingTrackModelImpl _$$CurrentlyPlayingTrackModelImplFromJson(
...
Map<String, dynamic> _$$CurrentlyPlayingTrackModelImplToJson(
        _$CurrentlyPlayingTrackModelImpl instance) =>
    <String, dynamic>{
