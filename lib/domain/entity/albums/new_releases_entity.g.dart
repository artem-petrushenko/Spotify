...
_$NewReleasesEntityImpl _$$NewReleasesEntityImplFromJson(
...
Map<String, dynamic> _$$NewReleasesEntityImplToJson(
        _$NewReleasesEntityImpl instance) =>
    <String, dynamic>{
...
_$AlbumsImpl _$$AlbumsImplFromJson(Map<String, dynamic> json) => _$AlbumsImpl(
      ...
      itemNewReleases: (json['item_new_releases'] as List<dynamic>?)
          ?.map((e) => ItemNewRelease.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
Map<String, dynamic> _$$AlbumsImplToJson(_$AlbumsImpl instance) =>
    <String, dynamic>{
      ...
      'item_new_releases':
          instance.itemNewReleases?.map((e) => e.toJson()).toList(),
    };

_$ItemNewReleaseImpl _$$ItemNewReleaseImplFromJson(Map<String, dynamic> json) =>
    _$ItemNewReleaseImpl(
...
Map<String, dynamic> _$$ItemNewReleaseImplToJson(
        _$ItemNewReleaseImpl instance) =>
    <String, dynamic>{
