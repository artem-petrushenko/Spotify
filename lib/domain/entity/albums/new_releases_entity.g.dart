...
_$_NewReleasesEntity _$$_NewReleasesEntityFromJson(Map<String, dynamic> json) =>
...
Map<String, dynamic> _$$_NewReleasesEntityToJson(
        _$_NewReleasesEntity instance) =>
    <String, dynamic>{
...
_$_ItemNewRelease _$$_ItemNewReleaseFromJson(Map<String, dynamic> json) =>
    _$_ItemNewRelease(
...
Map<String, dynamic> _$$_ItemNewReleaseToJson(_$_ItemNewRelease instance) =>
    <String, dynamic>{
