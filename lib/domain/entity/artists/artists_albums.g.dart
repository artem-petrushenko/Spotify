...
_$ArtistsAlbumsModelImpl _$$ArtistsAlbumsModelImplFromJson(
        Map<String, dynamic> json) =>
    _$ArtistsAlbumsModelImpl(
      json['href'] as String?,
      json['limit'] as int?,
      json['next'] as String?,
      json['offset'] as int?,
...
Map<String, dynamic> _$$ArtistsAlbumsModelImplToJson(
        _$ArtistsAlbumsModelImpl instance) =>
    <String, dynamic>{
      'href': instance.href,
